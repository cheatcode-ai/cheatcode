...
def ensure_dict(value: str | dict[str, Any] | None, default: dict[str, Any] | None = None) -> dict[str, Any]:
...
def ensure_list(value: str | list[Any] | None, default: list[Any] | None = None) -> list[Any]:
...
def safe_json_parse(value: str | dict | list | Any, default: Any = None) -> Any:
