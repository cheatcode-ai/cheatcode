...
async def get_credential_profiles(user_id: str = Depends(get_current_user_id_from_jwt)):
    ...
    try:
        ...
        return CredentialProfilesResponse(success=True, toolkits=toolkits, total_profiles=total)
...
async def get_profile_mcp_url(profile_id: str, user_id: str = Depends(get_current_user_id_from_jwt)):
...
async def delete_credential_profile(profile_id: str, user_id: str = Depends(get_current_user_id_from_jwt)):
...
async def bulk_delete_profiles(request: BulkDeleteRequest, user_id: str = Depends(get_current_user_id_from_jwt)):
    ...
    try:
        ...
        return {"success": True, "deleted_count": deleted, "requested_count": len(request.profile_ids)}
...
async def set_default_profile(profile_id: str, user_id: str = Depends(get_current_user_id_from_jwt)):
...
async def set_dashboard_default_profile(profile_id: str, user_id: str = Depends(get_current_user_id_from_jwt)):
...
async def toggle_profile_active(
    ...
    try:
        ...
        return {"success": True, "profile_id": profile_id, "is_active": updated.is_active}
...
async def get_dashboard_profiles(user_id: str = Depends(get_current_user_id_from_jwt)):
...
async def get_dashboard_mcp_urls(user_id: str = Depends(get_current_user_id_from_jwt)):
    ...
    try:
        ...
        return {"success": True, "mcp_configs": mcp_configs, "count": len(mcp_configs)}
