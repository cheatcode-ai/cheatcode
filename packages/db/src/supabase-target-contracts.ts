...
export const REQUIRED_INTEGRITY_CONSTRAINTS = [
  ...
  ["v2_retention_jobs", "v2_retention_jobs_day_check"],
  ["v2_retention_jobs", "v2_retention_jobs_phase_check"],
  ["v2_retention_jobs", "v2_retention_jobs_status_check"],
  ["v2_retention_jobs", "v2_retention_jobs_counter_check"],
  ["v2_retention_jobs", "v2_retention_jobs_error_code_check"],
  ["v2_retention_jobs", "v2_retention_jobs_activation_cursor_check"],
  ["v2_retention_jobs", "v2_retention_jobs_phase_cursor_check"],
  ["v2_retention_jobs", "v2_retention_jobs_lease_check"],
  ["v2_retention_jobs", "v2_retention_jobs_terminal_phase_check"],
...
export const REQUIRED_INTEGRITY_INDEXES = [
  ...
  "v2_retention_jobs_ready_idx",
  "v2_retention_jobs_lease_idx",
  "v2_retention_jobs_completed_idx",
] as const;
