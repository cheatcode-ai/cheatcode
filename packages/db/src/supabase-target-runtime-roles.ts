...
const COLUMN_GRANT_GROUPS: readonly ColumnGrantGroup[] = [
  ...
  columnGrant("INSERT", "app_webhooks", "v2_daily_maintenance_jobs", ["day", "scheduled_at"]),
  columnGrant("UPDATE", "app_webhooks", "v2_daily_maintenance_jobs", [
...
const POLICY_CONTRACTS: readonly PolicyContract[] = [
  ...
  maintenancePolicy("v2_daily_maintenance_jobs", "SELECT"),
  maintenancePolicy("v2_daily_maintenance_jobs", "INSERT"),
  maintenancePolicy("v2_daily_maintenance_jobs", "UPDATE"),
  maintenancePolicy("v2_daily_maintenance_jobs", "DELETE"),
