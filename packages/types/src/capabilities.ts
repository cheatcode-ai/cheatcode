...
export const TOOL_CAPABILITIES = [
  tool("browser", "browser_act", "Execute an action against an observed page ref.", SANDBOX_TOOL),
  tool("browser", "browser_extract", "Extract structured browser data.", SANDBOX_TOOL),
  tool("browser", "browser_observe", "Read a deterministic page tree with refs.", SANDBOX_TOOL),
