...
never returns the plaintext through the scheduled-task result or logs. Conclusive
results are applied later through an unexpired fingerprint-and-lease compare-and-set, so a
