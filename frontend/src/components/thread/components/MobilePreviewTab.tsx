          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <ol className="relative border-l border-zinc-200 dark:border-zinc-800 ml-3 space-y-8">
                <li className="ml-6">
                  ...
                  <h5 className="font-medium text-sm text-zinc-900 dark:text-zinc-200">
                    Install Expo Go
                  </h5>
                ...
                <li className="ml-6">
                  ...
                  <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1 leading-relaxed">
                    Use your camera or the Expo Go app to scan the QR code
                    above.
                  </p>
                </li>
              </ol>
            ...
            {expoUrl && (
              <div className="rounded-lg bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-3">
                <p className="text-[10px] uppercase tracking-wider text-zinc-400 mb-1 font-medium">
                  Expo URL
                </p>
            ...
            <div className="flex gap-3 items-start text-zinc-500 dark:text-zinc-400 px-1 pt-2">
              ...
              <p className="text-xs leading-relaxed">
                Preview may differ from native device. For accurate results,
