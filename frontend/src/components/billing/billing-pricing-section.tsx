...
export function BillingPricingSection({
  _insideDialog,
  ...props
}: { _insideDialog?: boolean; className?: string } & Record<string, unknown>) {
          ...
          >
            ...
            <div className="flex-1 space-y-4 mb-8">
              {plan.features.map((f) => (
                <div key={f} className="flex gap-3 items-start">
                  ...
                  <span className="text-xs text-zinc-400 font-mono leading-tight uppercase tracking-wide">
                    {f}
                  </span>
                </div>
              ))}
            ...
            <Button
              ...
              className={cn(
                ...
                isCurrent &&
                  'opacity-50 cursor-default hover:bg-transparent hover:text-zinc-500',
              )}
            >
