...
export const IdempotencyBeginBodySchema = z.strictObject({
...
const CachedResponseSchema = z.strictObject({
...
export const IdempotencyBeginResultSchema = z.discriminatedUnion("action", [
  ...
  z.strictObject({
    action: z.literal("conflict_request_in_flight"),
...
export const IdempotencyCompleteBodySchema = z.strictObject({
