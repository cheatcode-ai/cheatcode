...
const TOOL_SUMMARIES = [
  ...
  tool("media", "media_generate_image", "Generate an image artifact."),
  tool("media", "media_edit_image", "Edit an existing image artifact."),
  tool("media", "media_generate_video", "Generate a video artifact."),
  tool("media", "media_generate_speech", "Generate a speech audio artifact."),
  tool("media", "media_transcribe", "Transcribe audio."),
